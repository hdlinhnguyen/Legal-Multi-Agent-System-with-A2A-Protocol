...
def privacy_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia về bảo vệ dữ liệu cá nhân và GDPR. Phân tích khía cạnh bảo mật và quyền riêng tư trong câu hỏi:
    
Câu hỏi: {state['question']}
Phân tích pháp lý: {state.get('law_analysis', 'N/A')}

Tập trung: GDPR, CCPA, data protection, privacy rights, data breach, fines, compliance obligations."""
